...
public class TestGeneratectivity extends AppCompatActivity {
    ...
    private void createChineseQRCode() {
        QRCodeEncoder.encodeQRCode("二维码", CHZZQRCodeUtil.dp2px(TestGeneratectivity.this, 200), new QRCodeEncoder.Delegate() {
            @Override
    ...
    private void createEnglishQRCode() {
        QRCodeEncoder.encodeQRCode("chzz", CHZZQRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.parseColor("#ff0000"), new QRCodeEncoder.Delegate() {
            @Override
            public void onEncodeQRCodeSuccess(Bitmap bitmap) {
    ...
    private void createChineseQRCodeWithLogo() {
        QRCodeEncoder.encodeQRCode("二维码", CHZZQRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.parseColor("#795dbf"), BitmapFactory.decodeResource(TestGeneratectivity.this.getResources(), R.mipmap.logo), new QRCodeEncoder.Delegate() {
            @Override
            public void onEncodeQRCodeSuccess(Bitmap bitmap) {
    ...
    private void createEnglishQRCodeWithLogo() {
        QRCodeEncoder.encodeQRCode("chzz", CHZZQRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.parseColor("#0000ff"), BitmapFactory.decodeResource(TestGeneratectivity.this.getResources(), R.mipmap.logo), new QRCodeEncoder.Delegate() {
            @Override
            public void onEncodeQRCodeSuccess(Bitmap bitmap) {
